            ...
            <?php foreach ($allOrders as $order): ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <!-- view -->
                            <a href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/orders/list.php?view=<?= $order['id'] ?>">
                            ...
                            <!-- edit -->
                            <a href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/orders/add.php?edit=<?= $order['id'] ?>">
                            ...
                            <!-- delete -->
                            <a href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/orders/list.php?delete=<?= $order['id'] ?>">
