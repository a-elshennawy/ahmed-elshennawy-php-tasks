...
<section>
    <div class="container">
        <h3 class="allPordusctsListHeader">all products</h3>
        <table class="allPordusctsList">
            <thead>
                <td>id</td>
                <td>product name</td>
                <td>action</td>
            ...
            <?php foreach ($allProd as $item): ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <!-- view -->
                            <a href="http://localhost/instant-php/task-3/data/products/list.php/list.php?view=<?= $item['id'] ?>">
                            ...
                            <!-- edit -->
                            <a href="http://localhost/instant-php/task-3/data/products/list.php/add.php?edit=<?= $item['id'] ?>">
                            ...
                            <!-- delete -->
                            <a href="http://localhost/instant-php/task-3/data/products/list.php/list.php?delete=<?= $item['id'] ?>">
