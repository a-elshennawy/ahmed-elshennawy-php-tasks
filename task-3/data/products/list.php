...
if (isset($_GET['delete'])) {
    ...
    header("location:http://localhost/ahmed-elshennawy-php-tasks/task-3/data/products/list.php/list.php");
}
            ...
            <?php foreach ($allProd as $item): ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <!-- view -->
                            <a href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/products/list.php?view=<?= $item['id'] ?>">
                            ...
                            <!-- edit -->
                            <a href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/products/add.php?edit=<?= $item['id'] ?>">
                            ...
                            <!-- delete -->
                            <a href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/products/list.php?delete=<?= $item['id'] ?>">
...
<?php if (isset($_GET['view'])): ?>
    <div class="Modal">
        <div class="modalcontent">
            <h4>product details
                <a class="float-end" href="http://localhost/ahmed-elshennawy-php-tasks/task-3/data/products/list.php">
