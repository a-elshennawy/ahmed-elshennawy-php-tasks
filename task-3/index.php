...
<section>
  <div class="container">
    ...
    <div class="status row">
      <a href="http://localhost/instant-php/task-3/data/customers/list.php" class="count col-3">
        <h5 class="countTitle">our total customers</h5>
        <h1 class="countValue"><?= $allCounters['total_customers'] ?></h1>
      </a>
      <a href="http://localhost/instant-php/task-3/data/products/list.php" class="count col-3">
        <h5 class="countTitle">our total products</h5>
        <h1 class="countValue"><?= $allCounters['total_products'] ?></h1>
      </a>
      <a href="http://localhost/instant-php/task-3/data/orders/list.php" class="count col-3">
        <h5 class="countTitle">our total orders</h5>
        <h1 class="countValue"><?= $allCounters['total_orders'] ?></h1>
      </a>
      <a href="http://localhost/instant-php/task-3/data/customers/withoutorders.php" class="count col-3">
        <h5 class="countTitle">customers with no orders</h5>
        <h1 class="countValue"><?= $allCounters['customers_without_orders'] ?></h1>
      </a>
      <a href="http://localhost/instant-php/task-3/data/products/notordered.php" class="count col-3">
